#!/bin/bash
# Eval suffix_seq_7500 step_600 WITHOUT compaction on sokoban.
set -e
...
echo "=== Starting 4 baseline servers (suffix_7500 step_600) ==="
...
python scripts/eval_rg_mix.py \
    ...
    --output results_suffix7500_step600_baseline_sokoban_200.json
echo "=== Done ==="
